...
public class DbInitializer
{
    public static async Task SeedData(AppDbContext context, UserManager<User> userManager, RoleManager<IdentityRole> roleManager)
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            {
                Name = "Marisa",
                Start = new DateTime(2025, 6, 16, 09, 30, 00, DateTimeKind.Utc).AddDays(7 * i),
                End = new DateTime(2025, 6, 16, 11, 00, 00, DateTimeKind.Utc).AddDays(7 * i),
            });

            laundryBookings.Add(new()
            {
                Name = "Pepe",
                Start = new DateTime(2025, 6, 16, 12, 00, 00, DateTimeKind.Utc).AddDays(7 * i),
                End = new DateTime(2025, 6, 16, 13, 30, 00, DateTimeKind.Utc).AddDays(7 * i),
            });

            laundryBookings.Add(new()
            {
                Name = "Roberta",
                Start = new DateTime(2025, 6, 17, 15, 00, 00, DateTimeKind.Utc).AddDays(7 * i),
                End = new DateTime(2025, 6, 17, 16, 30, 00, DateTimeKind.Utc).AddDays(7 * i),
            });

            laundryBookings.Add(new()
            {
                Name = "Carlos",
                Start = new DateTime(2025, 6, 18, 11, 00, 00, DateTimeKind.Utc).AddDays(7 * i),
                End = new DateTime(2025, 6, 18, 12, 30, 00, DateTimeKind.Utc).AddDays(7 * i),
            });

            laundryBookings.Add(new()
            {
                Name = "Esteban",
                Start = new DateTime(2025, 6, 18, 16, 00, 00, DateTimeKind.Utc).AddDays(7 * i),
                End = new DateTime(2025, 6, 18, 17, 30, 00, DateTimeKind.Utc).AddDays(7 * i),
            });

            laundryBookings.Add(new()
            {
                Name = "Maria Cristina",
                Start = new DateTime(2025, 6, 19, 9, 00, 00, DateTimeKind.Utc).AddDays(7 * i),
                End = new DateTime(2025, 6, 19, 10, 30, 00, DateTimeKind.Utc).AddDays(7 * i),
            });

            laundryBookings.Add(new()
            {
                Name = "Pepita",
                Start = new DateTime(2025, 6, 20, 10, 30, 00, DateTimeKind.Utc).AddDays(7 * i),
                End = new DateTime(2025, 6, 20, 12, 00, 00, DateTimeKind.Utc).AddDays(7 * i),
            });
        }
